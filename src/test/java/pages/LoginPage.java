...
public class LoginPage extends CommonPage {
    ...
    @FindBy(xpath = "//input[@data-testing-id='login-userfield']")
    private WebElement userNameInput;
    @FindBy(xpath = "//input[@data-testing-id='login-passwordfield']")
    private WebElement userPasswordInput;
    @FindBy(xpath = "//button[@data-testing-id='login-submit-button']")
